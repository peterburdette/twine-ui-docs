  ...
  return (
    <div className="grid gap-6 sm:grid-cols-2 max-w-5xl">
      ...
      <div className="max-w-sm">
        <Card variant="elevated" elevation={2} radius="xl" padding="md">
          <CardMedia
            component="video"
      ...
      <div className="max-w-md">
        <Card variant="elevated" elevation={2} radius="xl" padding="md">
          ...
          <CardActions justify="between" divider="top">
            {/* Left utility actions */}
            <div className="flex items-center gap-1.5">
              <Tooltip content="Shuffle">
                <Button size="icon" variant="ghost" aria-label="Shuffle">
                  <Shuffle className="h-4 w-4" />
                </Button>
              </Tooltip>
              <Tooltip content="Repeat">
                <Button size="icon" variant="ghost" aria-label="Repeat">
            ...
            <div className="flex items-center gap-2">
              <Button size="icon" variant="outlined" aria-label="Previous">
              ...
              <Button size="icon" variant="outlined" aria-label="Next">
