export const RadioOrientationDemoCode = `'use client';
  ...
  return (
    <div className="grid grid-cols-2 gap-6 max-w-full">
      <div className="space-y-2 min-w-0">
        <p id="radio-orient-h" className="text-sm font-medium">Horizontal</p>
        <RadioGroup
      ...
      <div className="space-y-2 min-w-0">
        <p id="radio-orient-v" className="text-sm font-medium">Vertical</p>
        <RadioGroup
