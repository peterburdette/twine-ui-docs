export const InputSizesDemoCode = `import * as React from 'react';
  ...
  return (
    <div className="grid gap-3 sm:max-w-lg">
      <div className="flex flex-col gap-2">
        <Input label="Extra small" inputSize="xs" placeholder="xs" />
        ...
        <Input label="Extra large" inputSize="xl" placeholder="xl" />
      </div>
    </div>
  );
};
